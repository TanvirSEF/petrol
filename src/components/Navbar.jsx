            ...
            <nav className='bg-[#F40404] py-8'>
                <div className="max-w-container px-3 lg:px-0 mx-auto">
                    <div className=" flex justify-between items-center">
                        ...
                        <div className="">
                            <ul className={`lg:flex items-center pl-3 lg:pl-0 gap-x-6 absolute top-0 left-0 lg:static z-50 ${show == true ? " bg-[#282828] top-[227px] w-full duration-700 ease-in-out" : " top-[-200px] w-full duration-700 ease-in-out" }`}>
                                ...
                                <li><a className=' font-popps text-white font-semibold text-base mt-3 border-2 boredr-white py-[13px] px-8 rounded-sm inline-block' href="#">Contact</a></li>
                            </ul>
                        </div>
                        <div className="lg:hidden cursor-pointer font-popps font-semibold text-3xl text-white" onClick={()=>setShow(!show)}>
